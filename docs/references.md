...
External references should be verified before they are used for current product behavior or paper claims.

Seed references from the initial research brief:

| Source | URL | Use |
| --- | --- | --- |
| Introducing Codex | https://openai.com/index/introducing-codex/ | Background on Codex as implementation and verification layer |
